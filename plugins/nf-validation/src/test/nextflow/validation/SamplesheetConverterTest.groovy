...
class SamplesheetConverterTest extends Dsl2Spec{
    ...
    def 'errors' () {
        ...
        errorMessages[2].startsWith("\tSample 1: #/file: string [non_existing_file.tsv] does not match pattern")
        errorMessages[3] == "\tSample 1: #/number: expected type: Number, found: String"
        errorMessages[4] == "\tSample 1: The 'directory' file or directory (non_exsiting_folder) does not exist."
        errorMessages[5] == "\tSample 1: The 'file' file or directory (non_existing_file.tsv) does not exist."
