...
//         def List<Map<String,String>> samplesheetList = Utils.fileToJsonArray(samplesheetFile, schemaFile.toString(), Global.getSession().baseDir.toString())
